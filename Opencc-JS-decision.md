...
**真实场景：**
- 用户可能简繁体都会使用
- 浏览器设置 `zh-TW`，但输入"刘德华"（简体）
- 浏览器设置 `zh-CN`，但输入"張偉"（繁体）
...
|---------|-----------|---------|---------------|---------|
| 大陆用户 | zh-CN | "刘德华" | ✅ 300KB | "劉德華" ✅ |
| 台湾用户 A | zh-TW | "張偉" | ❌ 0KB | "張偉" ✅ |
| 台湾用户 B | zh-TW | "刘德华" | ✅ 300KB | "劉德華" ✅ |
