...
// Additional fallback chars: 莲(蓮), 奥(奧) - common in names like "莲友"
const SIMPLIFIED_CHARS = '国让观门车东钟华为开关书长刘赵张陈杨黄吴孙马罗郑谢许韩冯邓叶苏吕卢谭陆贾韦邹闫龙贺顾龚万钱严汤蒋范萧沈余潘戴乔赖庞樊兰颜倪温芦鲁葛毕聂丛齐庄涂谷时费纪欧项游阳卫鲍单宁闵解强边饶晋邬臧畅蒙闻莘党贡劳姬扶堵郦雍郤璩濮寿通扈冀郏农别晏充慕连茹习宦鱼容慎戈庾终暨衡步都满弘匡寇广禄阙殳沃利蔚越夔隆师巩厍晁勾敖融冷訾辛阚那简空曾毋沙乜养鞠须丰巢蒯相查后荆红竺权逯盖益桓公莲奥'

// Create regex dynamically to avoid long inline regex (prevents editor warnings)
// Regex is created once and reused for all calls (performance optimized)
